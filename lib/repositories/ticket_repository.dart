...
class TicketRepository {
  ...
  Future<bool> prepareDio(String envi) async {
    try {
      ...
      if (envi.toUpperCase() == 'DEV') {
        ...
        dio.options.baseUrl = 'http://localhost:64400/api/FinanceRebuild/';
        dioto.options.baseUrl = 'http://localhost:64400/api/TicketObject/';
      }
  ...
  Future<bool> rebuildFinance(String dateStart, String dateEnd) async {
    try {
      var response = await dio.get('RebuildFinance', queryParameters: {
        'startDate': dateStart,
        'endDate': dateEnd,
      });
  ...
  Future<bool> rebuildFinanceWithTicketSoldEvent(
    ...
    try {
      var response = await dio.get('RebuildFinanceTicketSold',
  ...
  Future<bool> rebuildFinanceWithTicketSoldByPartsEvent(
      String dateStart, String dateEnd) async {
    try {
      var response = await dio.get('RebuildFinanceTicketSoldByParts',
          queryParameters: {'startDate': dateStart, 'endDate': dateEnd});
      final int? statusCode = response.statusCode;
      if (statusCode! < 200 || statusCode > 400) {
        throw Exception(
  ...
  Future<bool> rebuildFinanceWithTicketPayoutEvent(
      String dateStart, String dateEnd) async {
    try {
      var response = await dio.get('RebuildFinanceTicketPayoutEvent',
          queryParameters: {'startDate': dateStart, 'endDate': dateEnd});
      final int? statusCode = response.statusCode;
      if (statusCode! < 200 || statusCode > 400) {
        throw Exception(
  ...
  Future<bool> rebuildFinanceWithTicketCounterPayedOutEvent(
      String dateStart, String dateEnd) async {
    try {
      var response = await dio.get('FinanceTicketCounterPayoutEvent',
          queryParameters: {'startDate': dateStart, 'endDate': dateEnd});
      final int? statusCode = response.statusCode;
      if (statusCode! < 200 || statusCode > 400) {
        throw Exception(
  ...
  Future<bool> rebuildFinanceWithTicketInterestRepaymentEvent(
      String dateStart, String dateEnd) async {
    try {
      var response = await dio.get('FinanceTicketInterestRepayedEvent',
          queryParameters: {'startDate': dateStart, 'endDate': dateEnd});
      final int? statusCode = response.statusCode;
      if (statusCode! < 200 || statusCode > 400) {
        throw Exception(
  ...
  Future<bool> rebuildFinanceWithTicketLoanRepaymentEvent(
      String dateStart, String dateEnd) async {
    try {
      var response = await dio.get('FinanceTicketLoanRepayedEvent',
          queryParameters: {'startDate': dateStart, 'endDate': dateEnd});
      final int? statusCode = response.statusCode;
      if (statusCode! < 200 || statusCode > 400) {
        throw Exception(
  ...
  Future<bool> rebuildFinanceWithTicketCounterInterestRepaymentEvent(
      String dateStart, String dateEnd) async {
    try {
      var response = await dio.get('FinanceTicketCounterInterestRepayedEvent',
          queryParameters: {'startDate': dateStart, 'endDate': dateEnd});
      final int? statusCode = response.statusCode;
      if (statusCode! < 200 || statusCode > 400) {
        throw Exception(
  ...
  Future<bool> rebuildFinanceWithTicketCounterLoanRepaymentEvent(
      String dateStart, String dateEnd) async {
    try {
      var response = await dio.get('FinanceTicketCounterLoanRepayedEvent',
          queryParameters: {'startDate': dateStart, 'endDate': dateEnd});
      final int? statusCode = response.statusCode;
      if (statusCode! < 200 || statusCode > 400) {
        throw Exception(
  ...
  Future<bool> rebuildFinanceWithTicketCounterSoldByPartsEvent(
      String dateStart, String dateEnd) async {
    try {
      var response = await dio.get('FinanceTicketCounterSoldByPartsEvent',
          queryParameters: {'startDate': dateStart, 'endDate': dateEnd});
      final int? statusCode = response.statusCode;
      if (statusCode! < 200 || statusCode > 400) {
        throw Exception(
