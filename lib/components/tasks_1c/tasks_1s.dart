...
Widget task1C(BuildContext ctx) {
  ...
  if (cstate is CalendarHasReadableValuesState) {
    return Column(children: [
      ...
      const Divider(color: Colors.black12),
      taskListItem(
          3, 'Проценты по договорам, открытым и закрытым день в день', '', ctx),
      const Divider(color: Colors.black12),
      taskListItem(
          4,
      ...
      const Divider(color: Colors.black12),
      taskListItem(
          15, 'Продажи частичные', '(для закрытых в этом периоде)', ctx),
      const Divider(color: Colors.black12),
      taskListItem(16, 'Продажи частичные',
          '(для закрытых в этом периоде с убытком)', ctx),
      const Divider(color: Colors.black12),
      taskListItem(
          17, 'Продажи частичные', '(для не закрытых в этом периоде)', ctx),
      const Divider(color: Colors.black12),
