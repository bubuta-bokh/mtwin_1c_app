  ...
  runApp(MultiRepositoryProvider(
    providers: [
      ...
      RepositoryProvider<TicketRepository>(
        create: (context) =>
            TicketRepository(RepositoryProvider.of<AuthRepository>(context)),
      ),
      RepositoryProvider<CustomerRepository>(
        create: (context) =>
            CustomerRepository(RepositoryProvider.of<AuthRepository>(context)),
      ),
      RepositoryProvider<AnalyticsRepository>(
        create: (context) =>
            AnalyticsRepository(RepositoryProvider.of<AuthRepository>(context)),
      ),
    ],
      ...
      providers: [
        ...
        BlocProvider<TicketBloc>(
          create: (ctx) {
            ...
            final ticketRepository =
                RepositoryProvider.of<TicketRepository>(ctx);
        ...
        BlocProvider<AnalyticsBloc>(
          create: (ctx) {
            ...
            return AnalyticsBloc(analyticsRepository: analyticsRepository)
              ..add(const AnalyticsInitialEvent(envi: 'DEBUG'));
          },
          lazy: false,
        ),
        BlocProvider<CustomerBloc>(
          create: (ctx) {
            ...
            final customerRepository =
                RepositoryProvider.of<CustomerRepository>(ctx);
            return CustomerBloc(customerRepository: customerRepository);
            //..add(CustomerInitialEvent());
          },
          lazy: false,
        ),
        ...
        BlocProvider<RunInto1cBloc>(
          create: (ctx) {
            final run1cRepository = RepositoryProvider.of<Run1cRepository>(ctx);
